...
// import { ConsultationMapper } from "../../../../data/presentation/mappers/mapper";
...
import { emptyConsultation } from "../../../../data/models/consultation";
...
export async function PATCH(req, { params }) {
  ...
  try {
    const dto = new ConsultationRequestDto(await req.json());
    ...
    const updatedConsultation = await consultationUseCase.updateConsultation(
      obj
    );
